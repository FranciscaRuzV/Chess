...
//post route to oin an existing game
...
router.get('/:gameCode',(req,res)=>{
    ...
    //if the game does not exist, we redirect whit error
    if(!game){
    ...
    //if the player is not the game, we redirect with error
